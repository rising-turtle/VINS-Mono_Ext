...
% simulate swing motion, create feature observation follow VINS pipeline
function [ obs, pts, vfeats ] = swing_simulation_data_VINS( tilt, H )
%% parameters 
param_global;
global g_param;
if nargin == 0
...
[obs, vfeats] = createObservations_VINS(vfeats, pts, tilt); 

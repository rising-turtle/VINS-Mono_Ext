...
%size() : returns size_t
%
classdef RangeFactorCalibratedCameraPoint < gtsam.NonlinearFactor
  properties
  ...
  methods
    function obj = RangeFactorCalibratedCameraPoint(varargin)
      ...
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'double') && isa(varargin{4},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1897, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1898, obj.ptr_gtsamRangeFactorCalibratedCameraPoint);
    end
    ...
    function varargout = clone(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCameraPoint.clone');
      end
    end
    ...
    function varargout = dim(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCameraPoint.dim');
      end
    end
    ...
    function varargout = keys(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCameraPoint.keys');
      end
    end
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCameraPoint.size');
      end
    end

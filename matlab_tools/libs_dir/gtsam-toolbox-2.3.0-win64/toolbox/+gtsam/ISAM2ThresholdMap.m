  ...
  methods
    function obj = ISAM2ThresholdMap(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1132, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1133);
      elseif nargin == 1 && isa(varargin{1},'gtsam.ISAM2ThresholdMap')
        my_ptr = gtsam_wrapper(1134, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1135, obj.ptr_gtsamISAM2ThresholdMap);
    end
    ...
    function varargout = insert(this, varargin)
      ...
      % 
      % Method Overloads
      % insert(ISAM2ThresholdMapValue value)

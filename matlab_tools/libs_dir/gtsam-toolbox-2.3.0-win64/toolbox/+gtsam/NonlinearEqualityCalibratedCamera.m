...
%size() : returns size_t
%
classdef NonlinearEqualityCalibratedCamera < gtsam.NonlinearFactor
  properties
  ...
  methods
    function obj = NonlinearEqualityCalibratedCamera(varargin)
      ...
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.CalibratedCamera')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1692, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.CalibratedCamera') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1693, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1694, obj.ptr_gtsamNonlinearEqualityCalibratedCamera);
    end
    ...
    function varargout = clone(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityCalibratedCamera.clone');
      end
    end
    ...
    function varargout = dim(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityCalibratedCamera.dim');
      end
    end
    ...
    function varargout = keys(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityCalibratedCamera.keys');
      end
    end
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityCalibratedCamera.size');
      end
    end

...
%size() : returns size_t
%
classdef NonlinearEqualityPose2 < gtsam.NonlinearFactor
  properties
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(1649, obj.ptr_gtsamNonlinearEqualityPose2);
    end
    ...
    function varargout = clone(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPose2.clone');
      end
    end
    ...
    function varargout = dim(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPose2.dim');
      end
    end
    ...
    function varargout = keys(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPose2.keys');
      end
    end
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPose2.size');
      end
    end

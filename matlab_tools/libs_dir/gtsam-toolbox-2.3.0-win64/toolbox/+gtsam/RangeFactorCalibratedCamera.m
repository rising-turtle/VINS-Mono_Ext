...
%size() : returns size_t
%
classdef RangeFactorCalibratedCamera < gtsam.NonlinearFactor
  properties
  ...
  methods
    function obj = RangeFactorCalibratedCamera(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1924, varargin{2});
        end
        base_ptr = gtsam_wrapper(1923, my_ptr);
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'double') && isa(varargin{4},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1925, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1926, obj.ptr_gtsamRangeFactorCalibratedCamera);
    end
    ...
    function varargout = clone(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCamera.clone');
      end
    end
    ...
    function varargout = dim(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCamera.dim');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NonlinearFactor') && isa(varargin{2},'double')
        gtsam_wrapper(1930, this, varargin{:});
      else
    ...
    function varargout = keys(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCamera.keys');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1934, this, varargin{:});
      else
    ...
    function varargout = printKeys(this, varargin)
      ...
      % printKeys(string s)
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1935, this, varargin{:});
      else
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorCalibratedCamera.size');
      end
    end

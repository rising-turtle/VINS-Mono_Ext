  ...
  methods
    function obj = Constrained(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        ...
        base_ptr = gtsam_wrapper(501, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(503, obj.ptr_gtsamnoiseModelConstrained);
    end
    ...
    function varargout = unit(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.noiseModel.Constrained.unit');
      end
    end

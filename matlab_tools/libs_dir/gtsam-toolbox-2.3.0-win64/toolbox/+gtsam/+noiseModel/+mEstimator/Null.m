...
classdef Null < gtsam.noiseModel.mEstimator.Base
  ...
  methods
    function obj = Null(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(529, varargin{2});
        end
        base_ptr = gtsam_wrapper(528, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(530);
      else
    ...
    function delete(obj)
      gtsam_wrapper(531, obj.ptr_gtsamnoiseModelmEstimatorNull);
    end

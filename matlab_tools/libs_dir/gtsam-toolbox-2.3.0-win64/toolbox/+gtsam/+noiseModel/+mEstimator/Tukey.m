...
classdef Tukey < gtsam.noiseModel.mEstimator.Base
  ...
  methods
    function obj = Tukey(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(547, varargin{2});
        end
        base_ptr = gtsam_wrapper(546, my_ptr);
    ...
    function delete(obj)
      gtsam_wrapper(549, obj.ptr_gtsamnoiseModelmEstimatorTukey);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(550, this, varargin{:});
      else

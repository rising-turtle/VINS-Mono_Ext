...
%size() : returns size_t
%
classdef NonlinearEqualityPoint2 < gtsam.NonlinearFactor
  properties
  ...
  methods
    function obj = NonlinearEqualityPoint2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1571, varargin{2});
        end
        base_ptr = gtsam_wrapper(1570, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Point2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1572, varargin{1}, varargin{2});
    ...
    function delete(obj)
      gtsam_wrapper(1574, obj.ptr_gtsamNonlinearEqualityPoint2);
    end
    ...
    function varargout = clone(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPoint2.clone');
      end
    end
    ...
    function varargout = dim(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPoint2.dim');
      end
    end
    ...
    function varargout = keys(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPoint2.keys');
      end
    end
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPoint2.size');
      end
    end

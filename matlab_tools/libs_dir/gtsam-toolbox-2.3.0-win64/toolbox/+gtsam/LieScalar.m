  ...
  methods
    ...
    function varargout = dim(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.LieScalar.dim');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      % 
      % Method Overloads
      % equals(LieScalar expected, double tol)
    ...
    function varargout = inverse(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.LieScalar.inverse');
      end
    end
    ...
    function varargout = value(this, varargin)
      ...
      if length(varargin) == 0
        ...
        error('Arguments do not match any overload of function gtsam.LieScalar.value');
      end
    end
